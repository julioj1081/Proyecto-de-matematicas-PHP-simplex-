    ...
    <body>
        <div class="container">
            <div id="seleccionar_metodo" class="jumbotron">
                ...
                <a onclick="display_simplex()" class="btn btn-lg btn-success" role="button">Comenzar un problema</a>
                <a href="./ayuda.html" class="btn btn-info" role="button" target="_blank">Ayuda</a>
                <br>
                <br>
                <br>
                <h4>Integrantes</h4>
                <p>Julio Alberto Fernandez Gonzalez</p>
                <p>Ivan Guadalupe Lozano Alarcón</p>
                <p>Yod Abraham Cortes Rincon</p>
                <p>David Aguilar Martínez</p>
                </div>
